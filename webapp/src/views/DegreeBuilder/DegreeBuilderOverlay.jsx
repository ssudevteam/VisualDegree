...
const DegreeBuilderOverlay = forwardRef((props, forwardRef) => {
        const initialDegreeList = ['Computer Science', 'Mathematics', 'Psychology', 'Business'];
        ...
        useEffect(() => {
            // TEMPORARY
            setDegreeList(['Computer Science', 'Mathematics', 'Psychology', 'Business']);
        ...
        const updateCourseListCallback = useCallback((degree) => {
        ...
        const resizeViewportNoSidebar = () => {
            ...
            if (bannerNavButton && banner) {
                bannerNavButton.style.setProperty('height', banner.clientHeight + 'px', 'important');
            }
        }

        const renderNavButton = () => {
            return (
                <button id="sidebarNavButton"
